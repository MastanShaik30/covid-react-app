...
mapboxgl.accessToken = 'pk.eyJ1IjoibWFzdGFuMzAiLCJhIjoiY2s5Nmo5NHM4MDBnMTNsbm8yZ2Q5aGRmciJ9.zkomixgRVBVLD9CqOwh34A' //process.env.REACT_APP_MAPBOX_ACCESS_TOKEN;
...
function Map() {
  ...
  // Initialize our map
  useEffect(() => {
    console.log("The data from URL is "+ JSON.stringify(data));
    if (data) {
      const map = new mapboxgl.Map({
        container: mapboxElRef.current,
        // style: 'mapbox://styles/notalemesa/ck8dqwdum09ju1ioj65e3ql3k',
        style: 'mapbox://styles/mastan30/ck96jk7py2oxj1invg9x7a1my',
        // style: 'mapbox://styles/mapbox/streets-v11',
        center: [ 14.16741, 8.40336],
        zoom: 1.4
      });
